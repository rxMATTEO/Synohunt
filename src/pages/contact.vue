...
useHead({
  title: 'About us',
  meta: [
    { name: 'description', content: 'Contact Synohunt' }
  ],
  link: [{
...
const gmailIcon = ref('pi pi-inbox');

function copyMail () {
  window.navigator.clipboard.writeText('synohunt.here@gmail.com');
  gmailIcon.value = 'pi pi-check';
}
</script>
